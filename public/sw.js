...
const ASSET_DIRS = ['/neon-strike/', '/neon-strike-2d/', '/fruit-slasher/', '/eight-ball/', '/triple-pile/', '/fish-hunter/', '/ludo/', '/umo/', '/assets/', '/icons/', '/concepts/'];
const ASSET_EXT = /\.(js|json|css|wasm|png|jpe?g|webp|avif|gif|svg|glb|gltf|bin|ktx2|hdr|wav|mp3|ogg|ttf|woff2?)$/i;
