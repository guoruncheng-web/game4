...
export function classify({frontendPaths,backendPaths,readFrontend,forceFull=false,baselineValid=true}) {
 ...
 for(const p of frontendPaths){
  ...
  else if(p==='.github/workflows/deploy.yml'||p==='deploy/acceptance-plan.mjs'||p==='tools/pwa/social-acceptance.mjs'||/^test\/deploy\//.test(p))plan.reasons.push('pipeline-only:'+p);
